...
class QueryConverterTest
{
    ...
    private static Set<ServiceQuery> createExpectedServiceQueries(final GeneralQuery generalQuery)
    {
        ...
        serviceQueries.add(new ServiceQuery(Supplier.ERIC, generalQuery));
        serviceQueries.add(new ServiceQuery(Supplier.JEFF, generalQuery));
    ...
    {
        GeneralQuery generalQuery = new GeneralQuery(5f, 0f, 1f, 25f, 2);
