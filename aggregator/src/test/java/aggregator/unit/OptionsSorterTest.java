...
class OptionsSorterTest
{
    ...
    static void setupSorterTest()
    {
        ...
        orderedServiceOptions.add(new ServiceOption(CarType.EXECUTIVE, Supplier.ERIC, MIN_PRICE+1));
        orderedServiceOptions.add(new ServiceOption(CarType.EXECUTIVE, Supplier.JEFF, MIN_PRICE));
    }
